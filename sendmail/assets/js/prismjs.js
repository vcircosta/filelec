var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
    Prism = function (e) {
        var t = /\blang(?:uage)?-([\w-]+)\b/i, a = 0, n = {}, s = {
            ...
            highlightElement: function (a, n, r) {
                var i = s.util.getLanguage(a), o = s.languages[i];
                ...
                var u = {element: a, language: i, grammar: o, code: a.textContent};

                function c(e) {
                    u.highlightedCode = e, s.hooks.run("before-insert", u), u.element.innerHTML = u.highlightedCode, s.hooks.run("after-highlight", u), s.hooks.run("complete", u), r && r.call(u.element)
                }
                ...
                if (s.hooks.run("before-highlight", u), u.grammar) if (n && e.Worker) {
                    var d = new Worker(s.filename);
                    d.onmessage = function (e) {
                        c(e.data)
                    }, d.postMessage(JSON.stringify({language: u.language, code: u.code, immediateClose: !0}))
                } else c(s.highlight(u.code, u.grammar, u.language)); else c(s.util.encode(u.code))
            },
        ...
        function o(e, t, a, n, l, d) {
            for (var p in a) if (a.hasOwnProperty(p) && a[p]) {
                ...
                for (var m = 0; m < g.length; ++m) {
                    ...
                    var f = g[m], h = f.inside, b = !!f.lookbehind, y = !!f.greedy, k = f.alias;
                    if (y && !f.pattern.global) {
                        var v = f.pattern.toString().match(/[imsuy]*$/)[0];
                        f.pattern = RegExp(f.pattern.source, v + "g")
                    }
                    for (var w = f.pattern || f, F = n.next, S = l; F !== t.tail && !(d && S >= d.reach); S += F.value.length, F = F.next) {
                        var A = F.value;
                        ...
                        if (!(A instanceof r)) {
                            ...
                            if (y) {
                                ...
                                var _ = P.index, E = P.index + P[0].length, $ = S;
                                for ($ += F.value.length; _ >= $;) $ += (F = F.next).value.length;
                                if (S = $ -= F.value.length, F.value instanceof r) continue;
                                for (var T = F; T !== t.tail && ($ < E || "string" == typeof T.value); T = T.next) x++, $ += T.value.length;
                                x--, A = e.slice(S, $), P.index -= S
                            } else if (!(P = i(w, 0, A, b))) continue;
                            _ = P.index;
                            var O = P[0], I = A.slice(0, _), N = A.slice(_ + O.length), z = S + A.length;
                            d && z > d.reach && (d.reach = z);
                            var D = F.prev;
                            if (I && (D = u(t, D, I), S += I.length), c(t, D, x), F = u(t, D, new r(p, h ? s.tokenize(O, h) : O, k, O)), N && u(t, F, N), x > 1) {
                                var C = {cause: p + "," + m, reach: z};
                                o(e, t, a, F.prev, S, C), d && C.reach > d.reach && (d.reach = C.reach)
                            }
                        }
                    }
                }
        ...
        if (e.Prism = s, r.stringify = function e(t, a) {
            ...
            var a = JSON.parse(t.data), n = a.language, r = a.code, i = a.immediateClose;
...
"undefined" != typeof module && module.exports && (module.exports = Prism), "undefined" != typeof global && (global.Prism = Prism), Prism.languages.markup = {
    ...
    keyword: [{
        ...
        pattern: /(^|[^.]|\.\.\.\s*)\b(?:as|assert(?=\s*\{)|async(?=\s*(?:function\b|\(|[$\w\xA0-\uFFFF]|$))|await|break|case|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally(?=\s*(?:\{|$))|for|from(?=\s*(?:['"]|$))|function|(?:get|set)(?=\s*(?:[#\[$\w\xA0-\uFFFF]|$))|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield|do)\b/,
        lookbehind: !0
    }],
    ...
    parameter: [{
        ...
        pattern: /((?:\b|\s|^)(?!(?:as|async|await|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally|for|from|function|get|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield|do)(?![$\w\xA0-\uFFFF]))(?:(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*\s*)\(\s*|\]\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*\{)/,
        lookbehind: !0,
        inside: Prism.languages.javascript
    }],
    ...
    if (void 0 !== Prism && "undefined" != typeof document) {
        ...
        var e = {
                ...
                h: "c",
                tex: "latex"
            }, t = "data-src-status", a = "loading", n = "loaded",
        ...
        Prism.hooks.add("before-highlightall", (function (e) {
            ...
            if (i.matches(s)) {
                ...
                var u = i.getAttribute("data-src"), c = r.language;
                if ("none" === c) {
                ...
                g.open("GET", u, !0), g.onreadystatechange = function () {
                    var e, a;
                    4 == g.readyState && (g.status < 400 && g.responseText ? (i.setAttribute(t, n), l.textContent = g.responseText, Prism.highlightElement(l)) : (i.setAttribute(t, "failed"), g.status >= 400 ? l.textContent = (e = g.status, a = g.statusText, "✖ Error " + e + " while fetching file: " + a) : l.textContent = "✖ Error: File does not exist or is empty"))
                }, g.send(null)
            }
        ...
        Prism.fileHighlight = function () {
            i || (console.warn("Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead."), i = !0), Prism.plugins.fileHighlight.highlight.apply(this, arguments)
        }
    }

    function o(e, t) {
        var a = e.className;
        a = a.replace(r, " ") + " language-" + t, e.className = a.replace(/\s+/g, " ").trim()
    }
}(), Prism.languages.markup = {
    comment: {pattern: /<!--(?:(?!<!--)[\s\S])*?-->/, greedy: !0},
    prolog: {pattern: /<\?[\s\S]+?\?>/, greedy: !0},
    ...
    e.languages.bash = {
        ...
        variable: n.variable,
        function: {
            pattern: /(^|[\s;|&]|[<>]\()(?:apropos|apt|aptitude|apt-cache|apt-get|aspell|automysqlbackup|awk|basename|bash|bc|bconsole|bg|bzip2|cal|cat|cfdisk|chgrp|chkconfig|chmod|chown|chroot|cksum|clear|cmp|column|comm|composer|cp|cron|crontab|csplit|curl|cut|date|dc|dd|ddrescue|debootstrap|df|diff|diff3|dig|dir|dircolors|dirname|dirs|dmesg|egrep|eject|env|ethtool|expand|expect|expr|fdformat|fdisk|fg|fgrep|file|find|fmt|fold|format|free|fsck|ftp|fuser|gawk|git|gparted|grep|groupadd|groupdel|groupmod|groups|grub-mkconfig|gzip|halt|head|hg|history|host|hostname|htop|iconv|id|ifconfig|ifdown|ifup|import|install|ip|jobs|join|kill|killall|less|link|ln|locate|logname|logrotate|look|lpc|lpr|lprint|lprintd|lprintq|lprm|ls|lsof|lynx|make|man|mc|mdadm|mkconfig|mkdir|mke2fs|mkfifo|mkfs|mkisofs|mknod|mkswap|mmv|more|most|mount|mtools|mtr|mutt|mv|nano|nc|netstat|nice|nl|nohup|notify-send|npm|nslookup|op|open|parted|passwd|paste|pathchk|ping|pkill|pnpm|popd|pr|printcap|printenv|ps|pushd|pv|quota|quotacheck|quotactl|ram|rar|rcp|reboot|remsync|rename|renice|rev|rm|rmdir|rpm|rsync|scp|screen|sdiff|sed|sendmail|seq|service|sftp|sh|shellcheck|shuf|shutdown|sleep|slocate|sort|split|ssh|stat|strace|su|sudo|sum|suspend|swapon|sync|tac|tail|tar|tee|time|timeout|top|touch|tr|traceroute|tsort|tty|umount|uname|unexpand|uniq|units|unrar|unshar|unzip|update-grub|uptime|useradd|userdel|usermod|users|uudecode|uuencode|v|vdir|vi|vim|virsh|vmstat|wait|watch|wc|wget|whereis|which|who|whoami|write|xargs|xdg-open|yarn|insert|Begin|Declare|Set|End|zsh|zypper|Drop|Create|CREATE|int|varchar|Insert|Select|from|where|Where|Update|set|into|values|null|primary|key|SELECT|FROM|WHERE|select|group|GROUP|by|BY|having|HAVING|order|ORDER|BY|by|like|LIKE|NULL|is|IS|table|TABLE|references|REFERENCES|on|ON|update|UPDATE|delete|DELETE|cascade|CASCADE|alter|ALTER|constraint|CONSTRAINT|Alter|default)(?=$|[)\s;|&])/,
            lookbehind: !0
        },
        keyword: {
            pattern: /(^|[\s;|&]|[<>]\()(?:if|then|else|elif|fi|for|while|in|case|esac|function|select|do|done|until|exists|not)(?=$|[)\s;|&])/,
            lookbehind: !0
        },
        builtin: {
    ...
    keyword: [{
        ...
        pattern: /(^|[^.]|\.\.\.\s*)\b(?:as|assert(?=\s*\{)|async(?=\s*(?:function\b|\(|[$\w\xA0-\uFFFF]|$))|await|break|case|class|const|continue|debugger|default|delete|else|enum|export|extends|finally(?=\s*(?:\{|$))|for|from(?=\s*(?:['"]|$))|function|(?:get|set)(?=\s*(?:[#\[$\w\xA0-\uFFFF]|$))|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield|do)\b/,
        lookbehind: !0
    }],
    function: /#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*(?:\.\s*(?:apply|bind|call)\s*)?\()/,
    number: /\b(?:(?:0[xX](?:[\dA-Fa-f](?:_[\dA-Fa-f])?)+|0[bB](?:[01](?:_[01])?)+|0[oO](?:[0-7](?:_[0-7])?)+)n?|(?:\d(?:_\d)?)+n|NaN|Infinity)\b|(?:\b(?:\d(?:_\d)?)+\.?(?:\d(?:_\d)?)*|\B\.(?:\d(?:_\d)?)+)(?:[Ee][+-]?(?:\d(?:_\d)?)+)?/,
    ...
    keyword: [/@(?:if|else(?: if)?|forward|for|each|while|do|import|use|extend|debug|warn|mixin|include|function|return|content)\b/i, {
    ...
    var t = /\/\*[\s\S]*?\*\/|\/\/.*|#(?!\[).*/, a = [{pattern: /\b(?:false|true)\b/i, alias: "boolean"}, {
